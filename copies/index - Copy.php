    ...
    <body>		
		...
		<div id="wrapper" class="container">
				...
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li><a href="./products.php">Fashion Accessories</a></li>
			...
			<section id="footer-bar">
				<div class="row">
					...
					<div class="span5">
						...
						<p>The logo of Koutureu is a symbol of a woman showing confidence in wearing her gown with whatever size she is.</p>
						<br/>
			...
			<section id="copyright">
				<span>Copyright 2018. Koutureu<br>Developed by zie.raine</span>
			</section>
		</div>
